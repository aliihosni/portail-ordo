...
$last =  date('Y-m-d',strtotime('2017-05-01 00:00:00')) ;
$next =  date('Y-m-d',strtotime('2017-05-08 00:00:00')) ;
...
foreach($daterange as $date){
    ...
    while($row2 = mysql_fetch_array($result2)) {
        ...
        $sql3 = ("SELECT count(*) as 'number' FROM swan where STR_TO_DATE(fin ,'%Y-%m-%d' ) = STR_TO_DATE('".$d."' , '%Y-%m-%d') and Demandeur = '".$row2["Demandeur"]."' and Type in('CHOTU3','OTUCR1','OTUMJ1') and swan.`Approb`!='595004 '");
