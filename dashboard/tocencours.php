<?php
$result = mysql_query("SELECT `Numero ticket`, `Date debut`, `Description`, `Date de creation`, `Etat`,`Technicien resp EDS actif` FROM `incidents` WHERE `Etat` Like 'En%'  ") ;
?>

<script type="text/javascript">
    $(function () {
        $('#datatables_tocencours').DataTable({
...
<table id="datatables_tocencours" class="table table-striped table-bordered" cellspacing="0" width="100%">
    <thead>
    <tr>
        <th>Numero ticket</th>
        <th>Date debut</th>
